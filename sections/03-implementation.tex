...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-home-a.png}\\[3pt]
    \small (а)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-home-b.png}\\[3pt]
    \small (б)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-home-c.png}\\[3pt]
    \small (в)
  \end{minipage}
...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-schedule-a.png}\\[3pt]
    \small (а)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-schedule-b.png}\\[3pt]
    \small (б)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-schedule-c.png}\\[3pt]
    \small (в)
  \end{minipage}
...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-personalization-a.png}\\[3pt]
    \small (а)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-personalization-b.png}\\[3pt]
    \small (б)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-personalization-c.png}\\[3pt]
    \small (в)
  \end{minipage}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.86\textwidth]{ios-liquid-glass.png}
...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-widgets-a.png}\\[3pt]
    \small (а)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-widgets-b.png}\\[3pt]
    \small (б)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{ios-widgets-c.png}\\[3pt]
    \small (в)
  \end{minipage}
...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{android-home-a.png}\\[3pt]
    \small (а)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{android-home-b.png}\\[3pt]
    \small (б)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{android-home-c.png}\\[3pt]
    \small (в)
  \end{minipage}
...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{android-schedule-a.png}\\[3pt]
    \small (а)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{android-schedule-b.png}\\[3pt]
    \small (б)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{android-schedule-c.png}\\[3pt]
    \small (в)
  \end{minipage}
...
\begin{figure}[h]
  ...
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{android-personalization-a.png}\\[3pt]
    \small (а)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{android-personalization-b.png}\\[3pt]
    \small (б)
  \end{minipage}\hfill
  \begin{minipage}[t]{0.31\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth]{android-personalization-c.png}\\[3pt]
    \small (в)
  \end{minipage}
...
Сборка Android-приложения выполняется средствами Gradle поверх Android Gradle Plugin~8.13.1 с целевым JDK~11; релизный артефакт --- Android App Bundle (\texttt{.aab}), создаваемый локально через интегрированную среду разработки Android~Studio (команда \emph{Build~$\to$~Generate Signed App Bundle}). Минификация и обфускация средствами R8 в текущей сборке отключены (\texttt{isMinifyEnabled = false}); правила \texttt{proguard-rules.pro} оставлены как заготовка под последующее включение. Настройка production-релизной подписи --- задача дальнейшего развития (см.~п.~\ref{subsubsec:impl-eval-future}).
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{web-landing.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{web-schedule-desktop.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.35\textwidth]{web-schedule-mobile.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{web-admin-dashboard.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{web-admin-groups.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{web-admin-editor.png}
